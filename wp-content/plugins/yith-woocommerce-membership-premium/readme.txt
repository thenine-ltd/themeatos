...
= 2.10.0 - Released on 08 February 2024 =

* New: support for WooCommerce 8.6
* Update: YITH plugin framework

= 2.9.0 - Released on 16 January 2024 =

* New: support for WooCommerce 8.5
* Update: YITH plugin framework

= 2.8.0 - Released on 19 December 2023 =

* New: support for WooCommerce 8.4
* Update: YITH plugin framework
* Fix: prevent fatal error if plan is not registered

= 2.7.0 - Released on 20 November 2023 =

* New: support for WordPress 6.4
* New: support for WooCommerce 8.3
* Tweak: added original price as parameter for 'yith_wcmbs_discount_product_price' filter
* Update: YITH plugin framework
* Dev: new filter 'yith_wcmbs_deactivate_membership'
* Dev: new filter 'yith_wcmbs_check_add_to_cart'
* Dev: new filter 'yith_wcmbs_user_has_access_to_post'

= 2.6.0 - Released on 03 October 2023 =

* New: support for WooCommerce 8.2
* Update: YITH plugin framework
* Dev: new filter 'yith_wcmbs_is_allowed_download'

= 2.5.0 - Released on 14 September 2023 =

* New: support for WooCommerce 8.1
* New: integration for YITH Dynamic Pricing & Discount 4.0
* Update: YITH plugin framework
* Fix: select placeholder visibility style issue
* Dev: new filter 'yith_wcmbs_get_downloads_by_product_id'

= 2.4.0 - Released on 31 July 2023 =

* New: hide price and add to cart buttons for members in new WooCommerce blockified templates
* Update: YITH plugin framework
* Update: language files
* Fix: membership protected content Gutenberg block
* Fix: avoid the use of wpautop when not needed
* Fix: showing global alternative content

= 2.3.0 - Released on 27 July 2023 =

* New: support for WordPress 6.3
* New: support for WooCommerce 8.0
* New: support for WooCommerce block templates rendering
* Update: YITH plugin framework
* Update: language files
* Fix: prevent undefined const in handleFloatingButtonVisibility function
* Tweak: new options for 'Members-only content start' Elementor block
* Tweak: improved reports tab style
* Tweak: added option to choose an Alternative Content in 'Members-Only content start' block
* Dev: new placeholder {membership_id} available for emails

= 2.2.0 - Released on 11 July 2023 =

* New: support for WooCommerce 7.9
* Update: YITH plugin framework
* Update: language files

= 2.1.0 - Released on 9 June 2023 =

* New: support for WooCommerce 7.8
* Update: YITH plugin framework
* Update: language files
* Fix: prevent fatal error when $order is bool
* Tweak: force balance tags when hiding the members-only content

= 2.0.0 - Released on 17 May 2023 =

* New: support for WooCommerce 7.7
* New: added HPOS support
* New: Your Store Tools tab
* New: panel UI
* New: Membership History gutenberg block
* New: Membership Protected Content gutenberg block
* New: Membership Items gutenberg block
* New: Membership Downloaded Product Links gutenberg block
* New: Membership Protected Links gutenberg block
* New: Membership Protected Media gutenberg block
* Update: YITH plugin framework
* Update: language files
* Fix: updated hook that caused issues with redirecting users without access to the content
* Fix: changed hook to download the protected media
* Fix: issue on calculating paused days when setting the membership to 'resumed' status
...
* Update: YITH plugin framework
* Update: language files
* Tweak: control check for prevent fatal error

= 1.22.0 - Released on 16 February 2023 =
...
* Update: YITH plugin framework
* Update: language files
* Dev: new filter 'yith_wcmbs_discount_product_price'
* Dev: new filter 'yith_wcmbs_user_membership_discount'
* Dev: new filter 'yith_wcmbs_check_is_expiring'

= 1.20.0 - Released on 15 December 2022 =
...
* Update: YITH plugin framework
* Update: language files
* Fix: wrong CSS class shown on download button
* Tweak: improved performances when retrieving downloadable variable products for showing them in membership contents if products can be downloaded by members
* Dev: action yith_wcmbs_admin_membership_plan_history_header and yith_wcmbs_admin_membership_plan_history_content
