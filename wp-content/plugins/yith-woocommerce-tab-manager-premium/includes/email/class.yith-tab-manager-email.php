				...
				if ( $this->from ) {
					...
					if ( $args['is_ajax'] ) {
						...
						if ( $return ) {
							...
							$message = "<span class='message_send'>" . esc_html__( 'Message sent!', 'yith-woocommerce-tab-manager' ) . '</span>';
						} else {
							$message = "<span class='error_message'>" . esc_html__( 'Error, Please Try Again!', 'yith-woocommerce-tab-manager' ) . '<br /></span>';
						}
