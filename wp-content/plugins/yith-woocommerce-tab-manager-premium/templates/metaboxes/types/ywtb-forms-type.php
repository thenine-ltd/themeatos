...
<div id="ywtb-form-field-container">
	<div class="ywtb-form-row">
		<div id="ywtb-form-name" class="ywtb-field">
			<span class="description desc_name"
				  style="float: left;padding-right: 30px;"><?php esc_html_e( 'Name', 'yith-woocommerce-tab-manager' ); ?></span>
			<?php
			$field_args = array(
				'id'    => $field['id'] . '_name',
		...
		<div id="ywtb-form-name-req" class="ywtb-field">
			<span class="description desc_name_req"
				  style="float: left;padding-right: 30px;"><?php echo esc_html( $req_label ); ?></span>
			<?php
			...
			yith_plugin_fw_get_field( $field_args, true );
			?>
			<span class="desc inline"><?php echo esc_html( $req_label_desc ); ?></span>
		</div>
	</div>
	<div class="ywtb-form-row">
		<div id="ywtb-form-webaddr" class="ywtb-field">
		<span class="description desc_webaddr"
			  style="float: left;padding-right: 30px;"><?php esc_html_e( 'Website', 'yith-woocommerce-tab-manager' ); ?></span>
			<?php
			$field_args = array(
	...
	<div class="ywtb-form-row">
		...
		<span class="description desc_subject"
			  style="float: left;padding-right: 30px;"><?php esc_html_e( 'Subject', 'yith-woocommerce-tab-manager' ); ?></span>
			<?php
			$field_args = array(
		...
		<span class="description desc_subject_req" style="float: left;padding-right: 30px;"><?php echo esc_html( $req_label ); ?></span>
			<?php
