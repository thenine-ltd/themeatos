...
<div id="<?php echo $field['id']; ?>-container" <?php echo yith_field_deps_data( $field ); //phpcs:ignore WordPress.Security.EscapeOutput ?> class="yith-plugin-fw-metabox-field-row">
