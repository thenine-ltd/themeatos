...
jQuery(document).ready(function () {
    ...
    jQuery('#customize-control-footer_social_repeater > .customizer-repeater-general-control-repeater> div:first-child').find('.customizer-repeater-box-content-hidden').css('display', 'block');
    ...
    theme_conrols.on('change', '.customizer-repeater-image-choice', function () {
        if(jQuery(this).find('option:selected').text()!== '--Please select--'){
         jQuery(this).parent().parent().find('.customizer-repeater-customize-control-title > label').text(jQuery(this).find('option:selected').text()+ ' icon settings');
        }else{
         jQuery(this).parent().parent().find('.customizer-repeater-customize-control-title > label').text('Social icon settings');
        }
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                field.find('.customizer-repeater-image-choice').val('wt_default');
                field.find('.customizer-repeater-customize-control-title > label').text('Social icon settings');
