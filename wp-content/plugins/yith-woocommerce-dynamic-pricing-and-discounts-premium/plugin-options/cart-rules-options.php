	...
	array(
		...
		'rules_type'    => array(
			...
			'exclude_from_discount' => array(
				...
				'options' => array(
					'exclude_disc_products'   => __( 'Specific products', 'ywdpd' ),
					'exclude_disc_categories' => __( 'Specific categories', 'ywdpd' ),
					'exclude_disc_tags'       => __( 'Specific tags', 'ywdpd' ),
				),
			),
		),
