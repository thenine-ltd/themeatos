...
== Changelog ==
= 2.1.7 - Released on 07 May 2021 =
* New: Support for WooCommerce 5.3
* Update: YITH plugin framework
* Fix: Issues with cart conditions on cart rules

= 2.1.6 - Released on 13 April 2021 =
* New: Support for WooCommerce 5.2
* Update: YITH plugin framework
* Fix: fixed an issue with YITH WooCommerce Badge Management
* Fix: fixed coupon amount

= 2.1.5 - Released on 23 March 2021 =
* Update: YITH plugin framework
* Dev: Added ywdpd_table_orientation filter to change the quantity table layout
* Fix: Cart rules not scheduling correctly
* Fix: Cart rule condition check for amount of orders did not work properly
* Tweak: Improve script to update also prices for the variation product with quantity table.

= 2.1.4 - Released on 03 March 2021 =
* Update: YITH plugin framework
* Fix: Wrong html escaping

= 2.1.3 - Released on 03 March 2021 =
* New: Support for WooCommerce 5.1
* New: Support for WordPress 5.7
* Update: YITH plugin framework
* Fix: Issue with Gift product rule not working correctly with variable products when variations were completely or partially configured
* Fix: Style issue with select2 and YITH Proteo

= 2.1.2 - Released on 11 February 2021 =
* Update: YITH plugin framework
* Update: Language files
* Fix: Discounted price not showing up in cart if the price is displayed tax excluded on the cart page

= 2.1.1 - Released on 11 February 2021 =
* Update: YITH plugin framework
* Update: Language files
* Fix: Wrong popup position on specific screen resolutions
* Fix: Discounted price not showing up in cart if the price is displayed tax excluded on the cart page

= 2.1.0 - Released on  02 February 2021 =
* New: Show special offer products in a modal window, after an add to cart event on the product page
* New: Support for WooCommerce 5.0
* Tweak: New popup style 
* Update: YITH plugin framework
* Update: Language files
* Dev: Added filter yith_ywdpd_can_init_plugin
* Dev: Added filter ywdpd_gift_subtotal
* Fix: Gift products not removed after a cart update
* Fix: Check if a variation is out of stock in popup

= 2.0.3 - Released on 04 January 2021 =
* New: Support for WooCommerce 4.9
* Update: YITH plugin framework
* Fix: Issue with Gift rules

= 2.0.2 - Released on 24 December 2020 =
* Update: YITH plugin framework
* Dev: Added filter ywdpd_skip_cart_process_discounts
* Fix: Price rules by product tag not applied in the cart
* Fix: Price on single product page not updated properly with the quantity table

= 2.0.1 - Released on 21 December 2020 =
* * Update: YITH plugin framework
* Dev: Added filter yith_ywdpd_quantity_pattern
* Fix: Cart rules for specific customers are applied also to guest users
* Fix: Gift rules on minimum subtotal are always applied in the cart
* Fix: Integration with YITH WOOCOMMERCE BRANDS ADD-ON Premium

= 2.0.0 - Released on 09 December 2020 =
* New: Plugin UI restyling
* New: Possibility to create price rule for the whole store
* New: Possibility to create price rule for product categories
* New: Possibility to create gift rule for minimum subtotal
* New: Support for WooCommerce 4.8
* New: Support for WordPress 5.6
* Tweak: Optimization of the price rules creation process
* Update: Language files
* Update: YITH plugin framework
