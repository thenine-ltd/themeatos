...
class SettingService {
    ...
    /**
     * Check if the config helper dialog should be auto-shown.
     *
     * @return bool `false` if the config helper must not be auto-shown.
     */
    public static function isAutoShowConfigHelper(): bool {
        return !get_option(SettingKey::WPCC_DISABLE_AUTO_SHOWING_CONFIG_HELPER);
    }
    ...
    /**
     * @return bool `true` if the expansion state of the sections should not be saved.
     */
    public static function isSavingSectionStateDisabled(): bool {
        return (bool) get_option(SettingKey::WPCC_DISABLE_SAVING_SECTION_STATES);
    }

    /**
     * @return bool `true` if the default section states must not be assigned for the site settings.
     */
    public static function isDefaultSiteSectionStatesDisabled(): bool {
        return (bool) get_option(SettingKey::WPCC_DISABLE_DEFAULT_SITE_SECTION_STATES);
    }
    ...
    public static function respondToAjaxRequest($data) {
        ...
        switch($requestType) {
            ...
            case "save_section_state":
                return (new SectionService())->handleSaveSectionStateRequest($data);
        }
