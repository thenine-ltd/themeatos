...
class SettingKey {
    ...
    const CATEGORY_CONVERT_JSON_TO_HTML              = '_category_convert_json_to_html';           // array    An array that defines CSS selectors that find JSON strings that will be converted to HTML
    const CATEGORY_CONVERT_JSON_TO_HTML_AUTO         = '_category_convert_json_to_html_auto';      // bool     True if the JSON strings found in the page should be converted to HTML elements
    ...
    const POST_CONVERT_JSON_TO_HTML                  = '_post_convert_json_to_html';                // array    An array that defines CSS selectors that find JSON strings that will be converted to HTML
    const POST_CONVERT_JSON_TO_HTML_AUTO             = '_post_convert_json_to_html_auto';           // bool     True if the JSON strings found in the page should be converted to HTML elements
    ...
    const POST_EMBED_MEDIA                           = '_post_embed_media';                         // bool     True if social media posts and other media should be embedded automatically in every possible place
    ...
    // Config helper
    const CONFIG_HELPER_AUTO_SHOW = '_config_helper_auto_show'; // bool     When `true`, the config helper will be auto-shown when the site settings page is loaded.
...
//    const WPCC_SPINNING_CHIMP_REWRITER_TEST                         = '_wpcc_spinning_chimp_rewriter_test';                           // string   Text for testing Chimp Rewriter
    ...
    const WPCC_DISABLE_AUTO_SHOWING_CONFIG_HELPER                   = '_wpcc_disable_auto_showing_config_helper';  // bool     True if the config helper auto-shown for the new sites should be disabled. Otherwise, false.
