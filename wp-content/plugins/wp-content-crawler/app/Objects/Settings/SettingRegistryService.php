...
class SettingRegistryService {
    ...
    private function createSiteSettingsRegistry(): SettingRegistry {
        ...
        return new SettingRegistry([
            ...
            (new SettingData(SettingKey::CATEGORY_CONVERT_JSON_TO_HTML,              ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_CATEGORY),
            (new SettingData(SettingKey::CATEGORY_CONVERT_JSON_TO_HTML_AUTO,         ValueType::T_BOOLEAN))->setTabKey(TabKey::SITE_SETTINGS_TAB_CATEGORY),
            ...
            (new SettingData(SettingKey::POST_FIND_REPLACE_CUSTOM_SHORT_CODE,        ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            ...
            (new SettingData(SettingKey::POST_FIND_REPLACE_CUSTOM_META,              ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            ...
            (new SettingData(SettingKey::TEST_FIND_REPLACE_FIRST_LOAD,               ValueType::T_STRING))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_FIND_REPLACE_RAW_HTML,                 ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_FIND_REPLACE_FIRST_LOAD,               ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_FIND_REPLACE_ELEMENT_ATTRIBUTES,       ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_EXCHANGE_ELEMENT_ATTRIBUTES,           ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_REMOVE_ELEMENT_ATTRIBUTES,             ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_FIND_REPLACE_ELEMENT_HTML,             ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_CONVERT_JSON_TO_HTML,                  ValueType::T_ARRAY))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            (new SettingData(SettingKey::POST_CONVERT_JSON_TO_HTML_AUTO,             ValueType::T_BOOLEAN))->setTabKey(TabKey::SITE_SETTINGS_TAB_POST),
            ...
            (new SettingData(SettingKey::POST_EMBED_MEDIA,                       ValueType::T_BOOLEAN, 'on'))->setTabKey(TabKey::SITE_SETTINGS_TAB_TEMPLATES),
            ...
            new SettingData(SettingKey::CONFIG_HELPER_AUTO_SHOW, ValueType::T_BOOLEAN, '1'),
        ]);
    }
    ...
    private function createGeneralSettingsRegistry(): SettingRegistry {
        ...
        return new SettingRegistry([
            ...
            (new SettingData(SettingKey::WPCC_DISABLE_AUTO_SHOWING_CONFIG_HELPER,  ValueType::T_BOOLEAN, false))->setTabKey(TabKey::GENERAL_SETTINGS_TAB_ADVANCED),
