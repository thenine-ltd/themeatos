...
class CategoryHtmlManipKeyFactory extends AbstractHtmlManipKeyFactory {
    ...
    public function getConvertJsonToHtmlKey(): string {
        return SettingKey::CATEGORY_CONVERT_JSON_TO_HTML;
    }

    public function getConvertJsonToHtmlAutoKey(): string {
        return SettingKey::CATEGORY_CONVERT_JSON_TO_HTML_AUTO;
    }
