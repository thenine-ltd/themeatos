...
<div class="dev-tools-content-container" data-wcc="<?php echo e(isset($data) && $data ? json_encode($data) : json_encode([])); ?>">
    ...
    <div class="dev-tools-content" tabindex="-1">
        ...
        <div class="blocking-loading-indicator hidden">
            <span class="message">
                <i class="fas fa-cog fa-spin"></i> <?php echo e(_wpcc('Loading...')); ?>
        ...
        <div class="toolbar">
            ...
            <div class="address-bar">
                <div class="button-container">
                    ...
                    <i class="fas fa-arrow-left fa-fw button-option back disabled"
                          title="<?php echo e(_wpcc("Click to go back")); ?>"></i>

                    
                    <i class="fas fa-arrow-right fa-fw button-option forward disabled"
                          title="<?php echo e(_wpcc("Click to go forward")); ?>"></i>

                    
                    <i class="fas fa-sync-alt fa-fw button-option refresh disabled"
                          title="<?php echo e(_wpcc("Click to refresh")); ?>"></i>
                </div>
                ...
                <div class="button-container">
                    ...
                    <i class="fas fa-play-circle fa-fw button-option go"
                       title="<?php echo e(_wpcc("Click to go to the URL")); ?>"></i>

                    
                    <i class="fas fa-bars fa-fw button-option sidebar-open"
                       title="<?php echo e(_wpcc("Click to open the sidebar")); ?>"></i>
                </div>
            </div>
...
<?php /**PATH /home/customer/www/themeatos.com/public_html/wp-content/plugins/wp-content-crawler/app/views/form-items/dev-tools/dev-tools-content-container.blade.php ENDPATH**/ ?>