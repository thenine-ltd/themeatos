<div class="input-group category-taxonomy <?php echo e(isset($remove) ? 'remove' : ''); ?> <?php echo e(isset($class) ? $class : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH /home/customer/www/themeatos.com/public_html/wp-content/plugins/wp-content-crawler/app/views/form-items/custom-post-category-taxonomy.blade.php ENDPATH**/ ?>