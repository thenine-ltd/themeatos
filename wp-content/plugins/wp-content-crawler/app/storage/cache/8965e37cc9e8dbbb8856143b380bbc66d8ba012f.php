...
<table class="wcc-settings">
    ...
    <?php echo $__env->make('form-items.combined.checkbox-with-label', [
        'name'  => \WPCCrawler\Objects\Settings\Enums\SettingKey::POST_EMBED_MEDIA,
        'title' => _wpcc('Embed social media posts and other media'),
        'info'  => _wpcc('Check this if you want to display social media posts and other media such as audio and video
            ...
            and HTML5 video and audio players display correctly on the front end.'),
    ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/customer/www/themeatos.com/public_html/wp-content/plugins/wp-content-crawler/app/views/site-settings/tab-templates.blade.php ENDPATH**/ ?>