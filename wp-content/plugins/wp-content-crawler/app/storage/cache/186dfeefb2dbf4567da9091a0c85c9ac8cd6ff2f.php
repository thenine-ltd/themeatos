<div class="input-group selector-custom-shortcode <?php echo e(isset($addon) ? 'addon dev-tools' : ''); ?> <?php echo e(isset($remove) ? 'remove' : ''); ?>"
    ...
    <?php endif; ?>
</div><?php /**PATH /home/customer/www/themeatos.com/public_html/wp-content/plugins/wp-content-crawler/app/views/form-items/selector-custom-shortcode.blade.php ENDPATH**/ ?>