...
class Requirements {
	...
	public static function get_env_details() {
		...
		$plugin_data = get_plugin_data( WPTELEGRAM_PRO_MAIN_FILE );
		...
		<tr class="plugin-update-tr">
			<td colspan="5" class="plugin-update colspanchange">
				<div class="update-message notice inline notice-error notice-alt" style="padding-block-end: 1rem;">
					<p>
						<?php esc_html_e( 'This plugin is not compatible with your website configuration.', 'wptelegram-pro' ); ?>
					</p>
					<span><?php esc_html_e( 'Missing requirements', 'wptelegram-pro' ); ?>&nbsp;👇</span>
								...
								<li>
									...
									echo esc_html(
										...
										/* translators: %s: Version number */
											__( 'Current version: %s', 'wptelegram-pro' ),
											$requirement['version']
										)
									);
									echo '&nbsp;&comma;&nbsp;';
									echo esc_html(
										sprintf(
										/* translators: %s: Version number */
											__( 'Minimum required version: %s', 'wptelegram-pro' ),
											$requirement['min']
										)
									);
									?>
							...
							<li>
								...
								echo esc_html(
									...
									/* translators: %s: comma separated list of missing extensions */
										__( 'Missing PHP extensions: %s', 'wptelegram-pro' ),
					...
					<span>
						<?php esc_html_e( 'Please contact your hosting provider to ensure the above requirements are met.', 'wptelegram-pro' ); ?>
					</span>
				</div>
			</td>
		</tr>
