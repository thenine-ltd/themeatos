...
class RequestCheck {
	...
	/**
	 * Whether the current request is of the given type.
	 *
	 * @since    3.0.0
	 *
	 ...
	 */
	public static function is( $type, $post = null ) {
		$is_rest_request = defined( 'REST_REQUEST' ) && REST_REQUEST;

		switch ( $type ) {
			case self::GB_METABOX:
			...
			case self::REST_PRE_INSERT:
				return $is_rest_request
					&& did_action( 'wptelegram_pro_rest_pre_insert_' . $post->post_type )
