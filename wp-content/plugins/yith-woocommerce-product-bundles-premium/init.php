...
if ( ! defined( 'YITH_WCPB_VERSION' ) ) {
	define( 'YITH_WCPB_VERSION', '1.4.9' );
}
...
if ( ! defined( 'YITH_WCPB_SECRET_KEY' ) ) {
	define( 'YITH_WCPB_SECRET_KEY', '1415b451be1a13c283ba771ea52d38bb' );
}
...
function yith_wcpb_pr_init() {
	...
	require_once 'includes/class.yith-wcpb-settings.php';
	require_once 'includes/class.yith-wcpb-out-of-stock-sync.php';
